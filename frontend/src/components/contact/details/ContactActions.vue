...
<template>
  ...
  <div v-if="props.showBlockConfirmation" class="mb-4">
    ...
    <div class="flex justify-center gap-4">
      <button @click="confirmBlock" class="bg-orange-800 hover:bg-orange-700 text-white py-2 px-4 rounded-md">
        Confirm
      </button>
      <button @click="hideConfirmations"
  ...
  <div v-else-if="props.showUnblockConfirmation" class="mb-4">
    ...
    <div class="flex justify-center gap-4">
      <button @click="confirmUnblock" class="bg-green-800 hover:bg-green-700 text-white py-2 px-4 rounded-md">
        Confirm
      </button>
      <button @click="hideConfirmations"
        class="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md">
  ...
  <div v-else-if="props.showRemoveConfirmation" class="mb-4">
    ...
    <div class="flex justify-center gap-4">
      <button @click="confirmRemove" class="bg-red-900 hover:bg-red-800 text-white py-2 px-4 rounded-md">
        Confirm
      </button>
      <button @click="cancelRemove" class="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md">
        Cancel
      </button>
    </div>
  </div>
  ...
  <div v-else class="flex flex-col gap-3">
    ...
    <!-- Remove Button -->
    <button @click="showRemoveConfirmation"
